    ...
    <div className="w-64 h-full text-white">
      ...
      <ScrollArea className="max-h-[calc(100vh-8rem)] p-2 overflow-y-auto ">
        {Object.keys(groupedChats).length > 0 ? (
          ...
          <p className="text-gray-400 p-4 common-text dark:text-[#001c4f]">
            No chats available.
          </p>
        )}
      </ScrollArea>
...
export default function Sidebar({
  ...
  return (
    <div
      ...
      } md:block fixed md:relative z-20 w-64 h-[calc(100vh-78px)] md:h-[calc(100vh-82px)] bg-gray-900 border-r border-gray-700 transition-all duration-300 ease-in-out overflow-y-auto`}
    >
      <Button
        variant="ghost"
    ...
    ${
      ...
      <div className="p-4 space-y-[8px]">
        <h3 className="text-sm font-semibold text-gray-400 mb-2 common-text dark:text-[#1E2A5E]">
          Chat With An AI Expert in:
        </h3>
